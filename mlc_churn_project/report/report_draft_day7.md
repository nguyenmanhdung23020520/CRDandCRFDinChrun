# Báo cáo nháp Day 7 - Project `mlc_churn`
...
[CHÈN BẢNG: mô tả bộ dữ liệu và nhóm biến]
...
[CHÈN BẢNG: churn_distribution.csv]

[CHÈN HÌNH: biểu đồ phân bố churn nếu bổ sung]
...
Phân tích tương quan trong Day 2 cho thấy các cặp biến `minutes-charge` có tương quan gần như tuyệt đối:
...
[CHÈN BẢNG: missing_values.csv]

[CHÈN BẢNG: minutes_charge_correlations.csv]

[CHÈN BẢNG: feature_selection_suggestion.csv]
...
[CHÈN BẢNG: crd_summary_by_k.csv]

[CHÈN BẢNG: Levene test CRD]

[CHÈN BẢNG: ANOVA CRD]

[CHÈN BẢNG: crd_tukey_results.csv]
...
[CHÈN BẢNG: crfd_summary_by_k_depth.csv]

[CHÈN BẢNG: crfd_summary_by_depth.csv]

[CHÈN BẢNG: crfd_summary_by_k.csv]

[CHÈN BẢNG: ANOVA CRFD]

[CHÈN BẢNG: crfd_tukey_k.csv]

[CHÈN BẢNG: crfd_tukey_max_depth.csv]

[CHÈN BẢNG: crfd_tukey_interaction.csv]
...
[BỔ SUNG TÀI LIỆU THAM KHẢO THEO QUY CÁCH TRÍCH DẪN CỦA MÔN HỌC]

- [BỔ SUNG] Đề bài hoặc tài liệu môn học Thiết kế và phân tích thực nghiệm.
- [BỔ SUNG] Tài liệu về Random Forest, F1-score, và stratified cross-validation.
- [BỔ SUNG] Tài liệu hoặc documentation đã sử dụng khi triển khai thí nghiệm.
